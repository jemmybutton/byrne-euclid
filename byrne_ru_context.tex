...
В геометрии используется понятие \quotation{переворачивание}, когда есть четыре пропорциональных величины, утверждается, что вторая к первой относится так же, как четвертая к третьей.
