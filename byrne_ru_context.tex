...
\problemNP{В}{круге}{углы в одной дуге равны между собой.}
...
\startsubproposition[title={Случай I.}]
Пусть дуга будет больше половины окружности, проведем \drawUnitLine{DF} и \drawUnitLine{BF} к центру.
...
\drawCurrentPictureInMargin
\startsubproposition[title={Случай II.}]
Пусть дуга будет меньше половины окружности, проведем диаметр \drawUnitLine{GA}, также проведем \drawUnitLine{GE}.
