...
draw byLabelsOnArc(A, B, C)(G);
draw byLabelsOnArc(D, E, F)(H);
...
\startProposition[title={Предложение XXIX. Задача},reference=prop:III.XXX]
\defineNewPicture{
pair A, B, C, D, E;
numeric r, t[];
path cr;
