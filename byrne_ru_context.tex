...
E := B shifted d;
F := C shifted d;
byAngleDefine(F, D, E, black, 0);
byAngleDefine(C, A, B, black, 0);
draw byNamedAngleResized();
byLineDefine(A, B, byred, 0, 0);
byLineDefine(B, C, black, 0, 0);
byLineDefine(C, A, byblue, 0, 0);
...
byAngleDefine(A, D, B, byred, 0);
byAngleDefine(A, C, D, black, 0);
byAngleDefine(D, B, A, black, 0);
draw byNamedAngleResized();
draw byLine(A, D, black, 0, 0);
byLineDefine(A, B, byred, 0, 0);
byLineDefine(C, D, byred, 1, 0);
...
byAngleDefine(A, E, C, black, 0);
byAngleDefine(A, F, D, white, 0);
draw byNamedAngleResized();
byLineDefine(A, C, byblue, 0, 0);
byLineDefine(B, D, byred, 0, 0);
byLineDefine(C, D, black, 0, 0);
...
byAngleDefine(D, C, A, black, 0);
byAngleDefine(A, G, D, black, 1);
draw byNamedAngleResized();
draw byLine(A, C, byred, 0, 0);
draw byLine(D, C, byblue, 0, 0);
...
byAngleDefine(L, N, M, black, 1);
byAngleDefine(F, E, D, black, 1);
byAngleDefine(N, M, L, byred, 1);
byAngleDefine(E, D, F, byred, 1);
byAngleDefine(K, A, L, black, 0);
byAngleDefine(L, C, K, black, 0);
draw byNamedAngleResized();
...
byAngleDefine(A, B, C, byyellow, 0);
byAngleDefine(B, C, A, byblue, 0);
byAngleDefine(C, A, B, black, 1);
byAngleDefine(D, C, E, byred, 0);
byAngleDefine(C, E, D, black, 0);
...
byAngleDefineExtended(D, F, E, byred, 1)(black);
...
byAngleDefineExtended(B, G, H, black, 1)(byred);
