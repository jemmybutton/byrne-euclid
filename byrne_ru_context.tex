...
$\left.
\eqalign{
\mbox{и } \therefore\drawAngle{DCB} &< \drawAngle{CDA,D}\cr
...
И~таким же образом можно показать, что никакая другая линия, кроме \drawUnitLine{AB} не $\parallel \drawUnitLine{CD}$; $\therefore \drawUnitLine{AB} \parallel \drawUnitLine{CD}$.
\stopCenterAlign
...
$\therefore$ согласно \inpropL[prop:I.VI], \inpropL[prop:I.XXIX] и \inpropL[prop:I.XXXIV]),\\ $\drawFromCurrentPicture[middle][squareFGHD]{
