...
Gроведем \drawUnitLine{CA} и~\drawUnitLine{BC} \inpost[post:I].\\
...
или же две прямые будут содержать пространство, что невозможно \inax[ax:X].
...
и, $\therefore$ две пересекающихся прямых параллельны одной и~той же прямой, что невозможно \inax[ax:XII].
