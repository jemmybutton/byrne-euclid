...
\kerncharacters[-0.01]{Скорость этого весьма заманчивого способа донесения знаний такова, что «Начала» Евклида могут быть усвоены менее чем за треть от времени, какое обычно требуется, а~сохранение в~памяти, напротив, намного более длительное. Эти факты были установлены во множестве экспериментов, проведенных как автором, так и~другими, внедрившими его задумку. Рецепт же короток и~очевиден: буквы, присвоенные точкам, линиям или другим частям построения, в~действительности всего лишь произвольные имена и~представляют те в~демонстрации, вместо этого части, получающие различные цвета, называют сами себя, так как их формы и~соответствующие цвета представляют их в~демонстрации.}
...
\drawCurrentPictureInMargin
\problemNP[2]{У}{глы}{при основании любого равнобедренного треугольника \drawLine[bottom]{BC,AC,AB} равны между собой и~по продолжении равных сторон углы под основанием будут равны между собой.}
...
$\therefore$ стороны \drawUnitLine{AB} и~\drawUnitLine{CA}, будут совпадать с~\drawUnitLine{DE} и~\drawUnitLine{FD} и~$\therefore \drawAngle{A} = \drawAngle{D}$.
...
\drawCurrentPictureInMargin
\problemNP[2]{В}{о}{всяком треугольнике \drawLine{DC,BC,BA,AD} если одна сторона \drawUnitLine{AD,DC} больше другой \drawUnitLine[0.5cm]{BC}, то противолежащий большей стороне угол будет больше противолежащего меньшей стороне угла, т.~е. $\drawAngle{DBC,ABD} > \drawAngle{A}$}
...
\drawCurrentPictureInMargin
\problemNP[2]{Л}{юбые}{две стороны \drawUnitLine{DA} и~\drawUnitLine{BD} всякого треугольника \drawLine[bottom]{DA,BD,AB} взятые вместе больше третьей стороны  \drawUnitLine{AB}.}
...
\problemNP{Е}{сли}{два угла одного треугольника соответственно равны двум углам другого треугольника ($\drawAngle{A} = \drawAngle{D}$ и~$\drawAngle{B} = \drawAngle{GED,FEG}$), и~одна сторона равна одного равна так же расположенной стороне другого, то и~остальные стороны и~углы соответственно равны друг другу.}
\drawCurrentPictureInMargin
...
$\therefore \drawAngle{DBE} = \drawAngle{C}$ \inax[ax:III], который и~будет углом в~накрестлежащем сегменте.
\stopCenterAlign
...
\startBook[title={Книга VI}]\unskip
...
\drawCurrentPictureInMargin
\problemNP[2]{Е}{сли}{подобные и~подобным образом описанные прямолинейные фигуры построены на сторонах прямоугольного треугольника \drawLine[bottom]{CA,DC,BD,AB}, фигура на стороне \drawProportionalLine{BD,DC} против прямого угла равна сумме фигур на двух других сторонах.}
