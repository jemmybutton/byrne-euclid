...
$\drawUnitLine{FC} = \drawUnitLine{AF}$ \indef[def:XV]\\
...
\startCenterAlign
Из центра \drawCircle[middle][1/4]{E} проведем $\drawProportionalLine{EF} \perp \drawProportionalLine{AF,FB}$ и~$\drawProportionalLine{EG} \perp \drawProportionalLine{CG,GD}$, соединим \drawProportionalLine{EA} и~\drawProportionalLine{EC}.
...
\drawCurrentPictureInMargin
\startCenterAlign
Теперь возьмем \drawUnitLine{BC} и~\drawUnitLine{FG} расположенные по разные стороны от центра или пересекающиеся. 

Проведем из центра \drawUnitLine{EL,LK} и~$\drawUnitLine{EH} \perp \drawUnitLine{FG} \mbox{ и~} \drawUnitLine{BC}$.
