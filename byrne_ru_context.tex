...
draw byPolygon(A,C,D)(byyellow);
byAngleDefineWithName(A, B, C, byblack, -1)(B);
byAngleDefineWithName(D, E, A, byblack, -1)(E);
...
Среди приведенных кратностей мы найдем что $\color[byred]{16} > \color[byblack]{14}$ и $\color[byblue]{20} > \color[byyellow]{18}$. То есть дважды первое больше дважды второго и дважды третье больше дважды четвертого. И~$\color[byred]{16} < \color[byblack]{21}$ и $\color[byblue]{20} < \color[byyellow]{27}$. То есть дважды первое меньше трижды второго и дважды третье меньше трижды четвертого. И~среди тех же кратностей мы найдем что $\color[byred]{72} > \color[byblack]{56}$ и $\color[byblue]{90} > \color[byyellow]{72}$. То есть 9 раз первое больше 8 раз второго и 9 раз третье больше 8 раз четвертого. Можно выбрать много других равнократных, которые будут показывать, что $\color[byred]{8}$, $\color[byblack]{7}$, $\color[byblue]{10}$, и $\color[byyellow]{9}$ пропорциональны, тогда как они таковыми не являются, поскольку мы можем найти кратное первого $>$ кратного второго, но столько же раз кратное, сколько первого, третьего не $>$ столько же раз кратного, сколько второго, четвертого. Например, 9 раз первое $>$ 10 раз второго, но 9 раз третье не $>$ 10 раз четвертого, то есть $\color[byred]{72} > \color[byblack]{70}$, но $\color[byblue]{90} \mbox{ не } > \color[byyellow]{90}$, или 8 раз первое $>$ 9 раз второго, но 8 раз третье не $>$ 9 раз четвертого, то есть $\color[byred]{64} > \color[byblack]{63}$, но $\color[byblue]{80} \mbox{ не } > \color[byyellow]{81}$. Когда можно найти такие кратные, говорят, что первое $\color[byred]{(8)}$ имеет ко второму $\color[byblack]{(7)}$ большее отношение, чем третье $\color[byblue]{(10)}$ к четвертому $\color[byyellow]{(9)}$, и наоборот, третье $\color[byblue]{(10)}$ имеет к четвертому $\color[byyellow]{(9)}$ меньшее отношение, чем первое $\color[byred]{(8)}$ ко второму $\color[byblack]{(7)}$.
\stopDefinition
