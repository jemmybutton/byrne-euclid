...
} расположена вовне, проведем из нее \drawUnitLine{AD,DE} к~центру, секущую \circleEI,\\
и проведем $\drawUnitLine{FD} \perp \drawUnitLine{DE}$,\\
опишем \drawCircle[middle][1/6]{EII} концентрический с~\circleEI\\ 
с~радиусом $= \drawUnitLine{AD,DE}$,\\
...
draw byCircleR(O, r, byblack, 0, 1, 1)(O);
draw byArc(O, A, B, r, byblack, 0, 0, 1, 0)(AB);
draw byArc(O, B, C, r, byblue, 0, 0, 1, 0)(BC);
draw byArc(O, C, F, r, byred, 0, 0, 1, 0)(CF);
