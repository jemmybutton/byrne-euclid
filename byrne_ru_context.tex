...
\drawCurrentPictureInMargin
\problemNP{И}{з}{данной точки \drawPoint[middle][AD]{D} на данной прямой \drawUnitLine{DB,CD} построить перпендикуляр.}

\startCenterAlign
Возьмем любую точку \drawPoint[middle][CA]{C} на данной прямой,\\
...
\drawCurrentPictureInMargin
\problemNP{П}{ровести}{перпендикуляр к~данной неограниченной прямой \drawUnitLine{DB,CD} из данной не находящейся на ней точки \drawPoint{A}.}

\startCenterAlign
Взяв данную точку \drawPoint{A} в~качестве центра по одну сторону прямой и~любое расстояние, позволяющее достигнуть другой стороны, построим \drawArc{O}.
...
\drawCurrentPictureInMargin
\problemNP[2]{Е}{сли}{из любой точки \drawPoint[middle][DE]{D} внутри треугольника \drawLine[bottom]{CA,EC,BE,AB} провести прямые линии к~концам стороны \drawSizedLine{AB}, эти прямые  вместе меньше двух других сторон треугольника и~будут заключать больший угол.}
...
\drawCurrentPictureInMargin
\problemNP{П}{ри}{данной точке \drawPoint{F} на данной прямой \drawUnitLine{FG,GJ} построить угол, равный данному прямолинейному углу \drawAngle{A}.}
...
\drawCurrentPictureInMargin
\problemNP{П}{ровести}{через данную точку \drawPoint[middle][EB]{E} прямую, параллельную данной прямой \drawUnitLine{CF,FD}.}

\startCenterAlign
Проведем \drawUnitLine{EF} из точки \drawPoint[middle][EB]{E}  к~любой точке \drawPoint[middle][CF]{F} на \drawUnitLine{CF,FD}.
...
\startCenterAlign
Через точку \drawPoint[middle][AD,AE]{A} проведем \\
...
Действительно, если рассматриваемая точка \drawPoint[middle][DH,DA,DF]{D}, в~которой встречается больше двух равных прямых линий, не центр, то какая-то другая \drawFromCurrentPicture[middle][pointF]{
...
Если данная точка \drawPoint[middle][FB]{B} расположена на окружности, ясно, что прямая $\drawUnitLine{AB} \perp \drawUnitLine{BE}$ радиусу и~будет искомой касательной \inprop[prop:III.XVI].

\startCenterAlign
Но если точка \drawPoint[middle][FB]{A} расположена вовне, проведем из нее \drawUnitLine{AD,DE} к~центру, секущую \circleEI,\\
