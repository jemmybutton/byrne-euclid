...
\drawCurrentPictureInMargin
\problemNP{Е}{сли}{у двух треугольников две стороны \drawUnitLine{AB} и~\drawUnitLine{CA} соответственно равны двум сторонам \drawUnitLine{DE} и~\drawUnitLine{FD} другого, но основания неравны, то угол над большим основанием \drawUnitLine{BC} одного треугольника больше угла под меньшим \drawUnitLine{EF} другого.}
...
\defineNewPicture{
	...
	draw byLine(O, B, byblack, THIN_WIDTH, REGULAR_WIDTH);
}\drawCurrentPictureInMargin
...
draw byLine(F, G, byblue, THIN_WIDTH, REGULAR_WIDTH);
...
draw byLine(M, G, byblue, THIN_WIDTH, REGULAR_WIDTH);
byLineDefine(A, E, byblack, DASHED_LINE, REGULAR_WIDTH);
byLineDefine(E, F, byblack, SOLID_LINE, REGULAR_WIDTH);
