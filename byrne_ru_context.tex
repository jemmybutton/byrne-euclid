...
Отсюда очевидно, что отсылки в~тексте к~построению считываются быстрее и~надежнее, если приводить формы и~цвета их частей или называть части по их цветам, чем если называть части и~буквы на построении. Помимо превосходной легкости, система также замечательна тем, что помогает сосредоточиться и~полностью исключает вредоносную, хотя и~распространенную практику передоверять всё доказательство памяти, до тех пора, пока рассуждения, факты и~доводы не оставят отпечаток в понимании.
