...
\drawCurrentPictureInMargin
\problemNP{В}{о}{всяком треугольнике, квадрат стороны, стягивающей острый угол меньше суммы квадратов сторон, содержащих этот угол, на дважды прямоугольник, заключенный между любой из этиcamera = bpy.data.objects['Camera']х сторон и отрезком, отсекаемым перпендикуляром из противоположного угла от этого отрезка или от продленного отрезка.\\
Первый случай.\\
