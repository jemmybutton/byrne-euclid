...
Теперь мы дадим определение точке, линии и~поверхности и~докажем предложение, чтобы показать верность этого суждения.
...
\startalignment[middle]
\emph{Если заменить диаграммы буквами}
\stopalignment
...
\drawUnitLine{AB} \cdot \drawUnitLine{AC}&\mbox{ или } \drawUnitLine{AC}^2\mbox{.}}\right.$
