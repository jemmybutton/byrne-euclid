...
\drawCurrentPictureInMargin
\problemNP{Е}{сли}{некоторая прямая \drawUnitLine{EF}, проходящая через центр круга \drawCircle[1/6]{E}, рассекает пополам хорду \drawUnitLine{AF,FB}, не проходящую через центр, то эта прямая ей перпендикулярна; а если перпендикулярна, то рассекает хорду пополам.}
