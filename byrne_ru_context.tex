...
{\tfxx Эта редакция и~перевод книги Оливера Бирна \emph{The first six books of the Elements of Euclid} подготовлены Сергеем Слюсаревым и~распространяются под лицензией CC-BY-SA 4.0}
\stopnarrower
