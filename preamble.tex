...
\def\drawPointM#1{\drawFromCurrentPicture[middle][pointm#1]{startAutoLabeling; draw byPointMarkRender(#1); draw byTextLabel(pointLabel)(str #1, #1, 90, textLabelShift); stopAutoLabeling;}}
