...
\def\drawsizedline[#1]#2{{%
	\iffirstargument%
		\drawFromCurrentPicture[middle][linesized#2#1]{startAutoLabeling;draw byNamedCompoundLine(#1, 2)(#2);stopAutoLabeling;}%
	\else%
		\drawFromCurrentPicture[middle][linesized#2]{startAutoLabeling;draw byNamedCompoundLine(2cm, 2)(#2);stopAutoLabeling;}%
	\fi%
}}
...
\def\drawsizedray[#1]#2{{%
	\iffirstargument%
		\drawFromCurrentPicture[middle][raysized#2#1]{startAutoLabeling;draw byNamedCompoundRay(#1, 2)(#2);stopAutoLabeling;}%
	\else%
		\drawFromCurrentPicture[middle][raysized#2]{startAutoLabeling;draw byNamedCompoundRay(2cm, 2)(#2);stopAutoLabeling;}%
	\fi%
}}
...
\def\drawpointl[#1][#2]#3{{%
	...
	\fi%
	\ifsecondargument%
		\drawFromCurrentPicture[\plal][pointl#3-#2]{startAutoLabeling; draw byNamedPointLines(#3,"#2"); stopAutoLabeling;}%
	\else%
