...
\def\definenewpicture[#1][#2]#3{\ignorespaces
	...
	\startMPinclusions{\currentInstance}
		input byrne;
		scaleFactor := \sfB;
...
\def\drawunitline[#1]#2{{\ignorespaces
	\iffirstargument\ignorespaces
		\drawFromCurrentPicture[middle][uline#2#1]{draw byNamedCompoundLine(#1)(#2);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[middle][uline#2]{draw byNamedCompoundLine(1cm)(#2);}\ignorespaces
	\fi\ignorespaces}}

\def\drawProportionalLine#1{\drawFromCurrentPicture[middle][lineprop#1]{draw byNamedCompoundLine(0)(#1);}}

\def\drawSizedLine{\dosingleempty\drawsizedline}
\def\drawsizedline[#1]#2{{\ignorespaces
	\iffirstargument\ignorespaces
		\drawFromCurrentPicture[middle][linesized#2#1]{draw byNamedCompoundLineSized(#1, 2)(#2);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[middle][linesized#2]{draw byNamedCompoundLineSized(2cm, 2)(#2);}\ignorespaces
	\fi\ignorespaces}}
...
\def\drawAngle#1{\drawFromCurrentPicture[middle][angle#1]{draw byNamedAngle(#1);draw byNamedAngleDummySides(#1);}}
...
\def\drawpolygon[#1][#2]#3{{\ignorespaces
	...
	\fi\ignorespaces
	\ifsecondargument\ignorespaces
		\drawFromCurrentPicture[\plal][#2]{draw byNamedPolygon(#3);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[\plal][polygon#3]{draw byNamedPolygon(#3);}\ignorespaces
	\fi\ignorespaces}}
...
\def\drawcircle[#1][#2]#3{{\ignorespaces
	...
	\else\ignorespaces
		\drawFromCurrentPicture[\plal][circle#3]{draw byNamedCircle(#3);}\ignorespaces
	\fi\ignorespaces}}
...
\def\drawarc[#1][#2]#3{{\ignorespaces
	...
	\else\ignorespaces
		\drawFromCurrentPicture[\plal][arc#3]{draw byNamedArc(#3);}\ignorespaces
	\fi\ignorespaces}}
...
\def\drawline[#1][#2]#3{{\ignorespaces
	...
	\fi\ignorespaces
	\ifsecondargument\ignorespaces
		\drawFromCurrentPicture[\plal][#2]{draw byNamedLineSeq(0)(#3);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[\plal][line#3]{draw byNamedLineSeq(0)(#3);}\ignorespaces
	\fi\ignorespaces}}
...
\def\drawmagnitude[#1][#2]#3{{\ignorespaces
	...
	\fi\ignorespaces
	\ifsecondargument\ignorespaces
		\drawFromCurrentPicture[\plal][magnitude#2#3]{draw byNamedMagnitude(#2)(#3);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[\plal][magnitude#3]{draw byNamedMagnitude(0)(#3);}\ignorespaces
	\fi\ignorespaces}}