...
\def\drawunitline[#1]#2{{\ignorespaces
	\iffirstargument\ignorespaces
		\drawFromCurrentPicture[middle][uline#2#1]{draw byNamedCompoundLine(#1, 0)(#2);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[middle][uline#2]{draw byNamedCompoundLine(1cm, 0)(#2);}\ignorespaces
	\fi\ignorespaces}}

\def\drawProportionalLine#1{\drawFromCurrentPicture[middle][lineprop#1]{draw byNamedCompoundLine(1cm, 1)(#1);}}

\def\drawSizedLine{\dosingleempty\drawsizedline}
\def\drawsizedline[#1]#2{{\ignorespaces
	\iffirstargument\ignorespaces
		\drawFromCurrentPicture[middle][linesized#2#1]{draw byNamedCompoundLine(#1, 2)(#2);}\ignorespaces
	\else\ignorespaces
		\drawFromCurrentPicture[middle][linesized#2]{draw byNamedCompoundLine(2cm, 2)(#2);}\ignorespaces
	\fi\ignorespaces}}
