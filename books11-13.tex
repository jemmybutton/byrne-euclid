...
\defineNewPictureBasedOnOld{
	...
	draw byCircleABC(L, M, N, byblack, 0, 0, 0)(LMN);
...
\defineNewPictureBasedOnOld{
	...
	byArcDefine (O', B', A')(1/2l, byblue, 0, 0, 0, 0) (O);
...
\startProposition[title={Prop. XXIV. Theor.}, reference=prop:XI.XXVI]
\defineNewPicture{
	color d[];
	d1 := (5/2cm, 0cm, 0cm);
	d2 := (1/5cm, 2cm, 0cm);
...
\drawCurrentPictureInMargin
\problemNP{O}{n}{On a given straight line, and at a given point on it, to construct a solid angle equal to a given solid angle.}
