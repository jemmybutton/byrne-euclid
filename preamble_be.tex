...
\hskip -\LettrineTotalWidth \hskip -\parindent \offset[y=0.79\LettrineTotalHeight,x=0pt]{\hbox{\putLettrine{#1}}}{\sc\hskip 5pt #2\ \it #3} \vskip \baselineskip
}
...
\fi\ignorespaces
\vskip -\LettrineTotalHeight
\hskip -\LettrineTotalWidth \hskip -\parindent \offset[y=0.79\LettrineTotalHeight,x=0pt]{\hbox{\putLettrine{#2}}}{\sc\hskip 5pt #3\ \it #4}\par\ignorespaces
