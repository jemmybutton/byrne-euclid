...
\starttypescriptcollection[ebgaramond-be]
	...
	\definefontfallback [ebgaramondmathtext] [file:EBGaramond12-Italic] [0x00068] [offset=0x0210E,force=yes] % for some reason math h is located here. see https://github.com/contextgarden/context-mirror/blob/1e5d7f41ddede5e6400a2a7762032823d3545df4/tex/context/base/mkiv/math-map.lua#L109 ?
	...
	\starttypescript [ebgaramond-be]
		\definetypeface[ebgaramond-be] [rm] [serif] [ebgaramond] [default] [designsize=auto]
