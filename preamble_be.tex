...
\starttypescriptcollection[ebgaramond-be]
	...
	\starttypescript [math] [ebgaramondandlatinmodern] 
		\definefontsynonym [MathRoman] [latinmodernmath] [features={math,mathextra},fallbacks=ebgaramondmathtext]
	\stoptypescript	
	\starttypescript [ebgaramond-be]
		...
		\definetypeface[ebgaramond-be] [mm] [math] [ebgaramondandlatinmodern] [default]
	\stoptypescript 
