...
\hskip -\LettrineTotalWidth \hskip -\parindent \offset[y=\LettrineTotalHeightMinusLine,x=0pt]{\hbox{\putLettrine{#1}}}{\sc\ #2\ \it #3} \vskip \baselineskip
}
...
\fi\ignorespaces
\vskip -\LettrineTotalHeight
\hskip -\LettrineTotalWidth \hskip -\parindent \offset[y=\LettrineTotalHeightMinusLine,x=0pt]{\hbox{\putLettrine{#2}}}{\sc\ #3\ \it #4}\par\ignorespaces
...
\setuphead[sectiononlyname][command=\definitionTitle,number=no,before={\blank[halfline]},after={\blank[halfline]}]
