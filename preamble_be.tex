...
{\externalfigure[lettrines/#1.pdf][width=1.2cm,height=1.2cm]\ignorespaces}
{\ignorespaces
	\ifx#1\plateName
		\framed[width=8cm,height=1.5cm,frame=off]{}\ignorespaces
	\else
		\framed[width=1.2cm,height=1.2cm]{\tfd #1}\ignorespaces
	\fi}\ignorespaces}}
...
% Fell Type, as suggested here: https://github.com/jemmybutton/byrne-euclid/issues/34
% currently doesn't work well: missing cyrillic script and some symbols
%\definefontfamily [mainface] [rm] [imfellenglish]
%\definefontfamily [mainface] [ss] [imfellenglish]
%\definefontfamily [mainface] [tt] [imfellenglish]
%\definefontfamily [mainface] [mm] [imfellenglish]
