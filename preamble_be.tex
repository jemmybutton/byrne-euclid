...
{\ignorespaces
	...
	\else
		\framed[width=1.5cm,height=1.5cm]{\tfd #1}\ignorespaces
	\fi}\ignorespaces}}
...
\def\marginNote#1{\inouter{~\hfill\framed[frame=off,location=top,width=4cm,align=flushleft,bodyfont=7pt]{#1}\hfill~}}
...
\def\drawcurrentpictureinmargin[#1]{
	\iffirstargument\ignorespaces
		\figureInMargin[#1]{\currentPicture}\ignorespaces
	\else\ignorespaces
		\figureInMargin{\currentPicture}\ignorespaces
	\fi\ignorespaces
}
...
\starttypescriptcollection[ebgaramond-be]
	\starttypescript [serif] [ebgaramond-be]
		...
		\definefontsynonym [SerifBold] [file:ebgaramond-bold] [features=eb-garamond-be-normal] 
		\definefontsynonym [SerifCaps] [Serif] [features=eb-garamond-be-smallcaps]
	\stoptypescript
	\definefontfallback [ebgaramondmathtext] [file:EBGaramond12-Regular.otf*eb-garamond-be-mathdigits] [digitsnormal] [force=yes]
	...
	\definefontfallback [ebgaramondmathtext] [file:EBGaramond12-Italic] [0x00068] [offset=0x0210E,force=yes] % due to some spooky quantum effects lowercase italic math h is located here
