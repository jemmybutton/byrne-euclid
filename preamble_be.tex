...
\def\qedNB{\hfill Q. E. D.\vskip 10pt}
...
\define[2]\bookTitle{\vbox{\vskip -\topspace\hbox{\putLettrine{\plateName}}\vskip 3\baselineskip~\hfill\hbox{\tfd #2}\hfill~}}
...
\def\drawcurrentpictureinmargin[#1]{
	\iffirstargument\ignorespaces
		\figureInMargin[#1]{\startMPcode{\currentInstance} draw currentPicture;\stopMPcode}
	\else\ignorespaces
		\figureInMargin{\startMPcode{\currentInstance} draw currentPicture;\stopMPcode}
	\fi\ignorespaces
}
